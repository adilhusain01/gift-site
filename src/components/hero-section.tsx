    ...
    <section className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
        ...
        >
          ...
          <span className="text-lg font-medium">Premium Gifting Experience</span>
        ...
        >
          <Button 
            ...
            className="bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white border-0 px-8 py-6 text-lg font-semibold group"
          >
            Explore Gifts
